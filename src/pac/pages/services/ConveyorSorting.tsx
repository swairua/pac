...
function ConveyorSorting() {
  ...
  return (
    <Box>
      ...
      <Box
        sx={{
          background: 'linear-gradient(rgba(30, 60, 114, 0.8), rgba(42, 82, 152, 0.8)), url("https://images.pexels.com/photos/10039994/pexels-photo-10039994.jpeg?w=1920&h=800&fit=crop&crop=center")',
